...
const ReviewSlider = () => {
    ...
    return (
        <section className=" w-11/12 sm:w-full mx-auto relative z-50">
            <div className='flex flex-col justify-center px-8 z-50 text-white gap-5'>
                <h1 className='text-4xl font-semibold'>What Our Clients Are Saying <span className="text-green-400">About Us</span> </h1>
                <p className='text-gray-400'>Enhance convenience and mobility, easy to use, get effortlessly honest reviews.</p>
            </div>
                    ...
                    {reviews.map((review, index) => {
                        ...
                        return (
                            <SwiperSlide className='py-10' key={review.id}>
                                <div
                                    className={`transition-all duration-500 ${cardStyle} bg-[#192420] p-6 min-w-64 h-72 rounded-xl shadow-xl`}
                                >
                                    <div className='flex gap-1 py-4'>
                                        <Star className='fill-[#1FFFA5] text-[#1FFFA5] size-4'></Star>
                                        <Star className='fill-[#1FFFA5] text-[#1FFFA5] size-4'></Star>
                                        <Star className='fill-[#1FFFA5] text-[#1FFFA5] size-4'></Star>
                                        <Star className='fill-[#1FFFA5] text-[#1FFFA5] size-4'></Star>
                                        <Star className='fill-[#1FFFA5] text-[#1FFFA5] size-4'></Star>
                                    </div>
                                    <p className="text-base-content/70 text-sm mb-3">"{review.review}"</p>
                                    <div className='flex justify-center items-center'>
                                        <div className="hidden md:block bg-dotted h-2 w-full "></div>
                                    </div>
